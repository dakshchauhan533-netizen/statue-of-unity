<?php
    ...
    if(isset($_POST['update'])){
        ...
        if($img){
            ...
            $update = "UPDATE `places` SET `place_name`='$name',`o_time`='$o_time',`c_time`='$c_time',`a_price`='$a_price',`c_price`='$c_price',`img`='$newfn' WHERE id='$p_id'";
            ...
            $update = "UPDATE `places` SET `place_name`='$name',`o_time`='$o_time',`c_time`='$c_time',`a_price`='$a_price',`c_price`='$c_price' WHERE id='$p_id'";
...
<body>
                ...
                <div class="my_form">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="div_deg">
                            ...
                            <input type="text" value="<?php echo $row['place_name'] ?>" name="p_name">
                        </div>

                        <div class="div_deg">
                            <label>Open Time:</label>
                            <input type="text" value="<?php echo $row['o_time'] ?>" name="o_time">                             
                        </div>

                        <div class="div_deg">
                            <label>Close Time:</label>
                            <input type="text" value="<?php echo $row['c_time'] ?>" name="c_time">
                        </div>

                        <div class="div_deg">
                            <label for="a_price">Adult Price:</label>
                            <input type="number" value="<?php echo $row['a_price'] ?>" name="a_price">
                        </div>

                        <div class="div_deg">
                            <label for="c_price">Child Price:</label>
                            <input type="number" value="<?php echo $row['c_price'] ?>" name="c_price">
                        </div>

                        <div class="div_deg">
                            <label>Current Image:</label>
                            <img src="../images/<?php echo $row['img'] ?>" alt="image" height="80" height="80">
                        </div>
    ...
    <script>
        document.querySelector("form").addEventListener("submit", function (e) {
            ...
            // Check if a file was uploaded and validate its type
